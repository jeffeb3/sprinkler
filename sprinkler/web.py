...
class Web(object):
    ...
    def __init__(self, sprinkler):
        """
        Web interface for the sprinkler.

        :sprinkler: The Sprinkler class.
        """

        self.log = logging.getLogger('sprinkler.Web')
    ...
    def measurementSse(self):
        ...
        '''  Generator function to view data and send all data received from
        it to the webpage as HTML5 server sent events. '''
    ...
    def daq(self):
        ...
        # Send the data to the web page in the server sent event format.
        return json.dumps(self.sprinkler.copyData(), indent=4)
    ...
    def email_test(self):
        ...
        try:
            problems = sendemail(email_from, email_to, [], 'Test email from the sprinkler',
    ...
    def javascriptCallback(self, path):
        ...
        if path == "updater.js":
            return template('updater', timezone = time.timezone * 1000.0, **self.sprinkler.getPlotHistory())
